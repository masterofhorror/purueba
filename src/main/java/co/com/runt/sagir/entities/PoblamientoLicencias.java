...
@SqlResultSetMappings({
    @SqlResultSetMapping(name = "poblamientoLicencias", entities = {
        @EntityResult(entityClass = PoblamientoLicencias.class, fields = {
...
public class PoblamientoLicencias implements Serializable{
