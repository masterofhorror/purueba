...
@SqlResultSetMappings({
    @SqlResultSetMapping(name = "civResidencias", entities = {
        @EntityResult(entityClass = CivResidencias.class, fields = {
            @FieldResult(name = "linea", column = "LINEA"),
            @FieldResult(name = "codCarga", column = "CODCARGA"),
            @FieldResult(name = "tipoDent", column = "RESTIPID"),
            @FieldResult(name = "nroDent", column = "RESNIT"),
            @FieldResult(name = "codCriterio", column = "RESCODCRITERIO"),
            @FieldResult(name = "descripcionError", column = "DESCRIPCION")
        })
    })
})
public class CivResidencias implements Serializable{
