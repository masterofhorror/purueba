...
@SqlResultSetMappings({
    @SqlResultSetMapping(name = "poblamientoResidencias", entities = {
        @EntityResult(entityClass = PoblamientoResidencias.class, fields = {
            @FieldResult(name = "linea", column = "LINEA"),
            @FieldResult(name = "codCarga", column = "CODCARGA"),
            @FieldResult(name = "tipoDent", column = "TIPIDENT"),
            @FieldResult(name = "nroDent", column = "NROIDENT"),
            @FieldResult(name = "codCriterio", column = "COD_CRITERIO"),
            @FieldResult(name = "descripcionError", column = "DESCRIPCION_DEL_ERROR")
        })
    })
})
public class PoblamientoResidencias implements Serializable{
