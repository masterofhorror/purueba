...
@SqlResultSetMappings({
    @SqlResultSetMapping(name = "poblamientoPersonas", entities = {
        @EntityResult(entityClass = PoblamientoPersonas.class, fields = {
...
public class PoblamientoPersonas implements Serializable{
