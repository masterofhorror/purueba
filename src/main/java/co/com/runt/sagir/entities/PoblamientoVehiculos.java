...
@SqlResultSetMappings({
    @SqlResultSetMapping(name = "poblamientoVehiculos", entities = {
        @EntityResult(entityClass = PoblamientoVehiculos.class, fields = {
...
public class PoblamientoVehiculos implements Serializable{
